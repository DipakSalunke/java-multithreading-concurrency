package s04_performance_optimization;
 ...
 */
public class LatencyImageChange {
    public static final String SOURCE_FILE = "./resources/new.jpg";
    public static final String DESTINATION_FILE = "./resources/old.jpg";
